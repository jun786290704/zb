...
export function getConfigValue(key: string, chain?: string): any {
  ...
  let currentChain = localStorage.getItem('currentChain') || 'POLYGON';
...
let networkId = getConfigValue('VUE_APP_NETWORK_ID') || '80001';
...
async function setUpStakingContracts(web3: Web3) {
  networkId = getConfigValue('VUE_APP_NETWORK_ID') || '80001';

...
function hdWalletProviderOptions(privateKeyEnvVarValue, mnemonicPhraseEnvVarValue, otherOpts) {
  ...
  if(privateKeyEnvVarValue) {
    ...
    opts.mnemonic = 'daughter endless army edge daring alone maze opera grief drop theory room';
  }
  return opts;
}
  ...
  networks: {
    ...
    bsctestnet: {
      provider: () => new HDWalletProvider(hdWalletProviderOptions(
        ...
        {
          providerOrUrl: process.env.BINANCE_TESTNET_RPC_URL || 'wss://data-seed-prebsc-2-s2.binance.org:8545/'
        }
      )),
      network_id: 0x61,
      confirmations: 10,
    ...
    bscmainnet: {
      provider: () => new HDWalletProvider(hdWalletProviderOptions(
        ...
        {
          providerOrUrl: process.env.BINANCE_MAINNET_RPC_URL || 'https://bsc-dataseed4.defibit.io/'
        }
      )),
      gasPrice: 5000000000,
      network_id: 0x38,
    ...
    hecomainnet: {
      provider: () => new HDWalletProvider(hdWalletProviderOptions(
        ...
        {
          providerOrUrl: process.env.HECO_MAINNET_RPC_URL || 'https://http-mainnet.hecohain.com'
        }
      )),
      network_id: 0x80,
      confirmations: 10,
    ...
    ccmtest: {
      provider: () => new HDWalletProvider(mnemonic, `http://192.168.10.200:8414`),
    ...
    ethtestnet: {
      provider: () => new HDWalletProvider(hdWalletProviderOptions(
        ...
        process.env.OKEX_MAINNET_WALLET_MNEMONIC,
        {
          providerOrUrl: 'http://192.168.10.200:8414' //https://rpc.testnet.fantom.network

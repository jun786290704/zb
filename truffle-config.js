...
function hdWalletProviderOptions(privateKeyEnvVarValue, mnemonicPhraseEnvVarValue, otherOpts) {
  ...
  if(privateKeyEnvVarValue) {
    ...
    opts.mnemonic = "caught bless negative spirit fit prosper razor ready scare dolphin ghost open";
  }
  return opts;
}
...
module.exports = {
  ...
  networks: {
    ...
    ccmtest: {
      provider: () => new HDWalletProvider('2c122232dddcf4370ecb1f265ce7ff28a40dd72bcec0df48db1511ef2fad763d', `http://192.168.10.200:8414`),
    ...
    ethtestnet: {
      provider: () => new HDWalletProvider(hdWalletProviderOptions(
        ...
        process.env.OKEX_MAINNET_WALLET_MNEMONIC,
        {
          providerOrUrl: process.env.POLYGON_TESTNET_RPC_URL ||'http://192.168.10.200:8414' //https://rpc.testnet.fantom.network
  ...
  api_keys: {
    ...
    hecoinfo: "KCYQTFT41IVFQC8CI5FEGTJTNI7Q233KK5",
    OKLink: process.env.OKLINK_API_KEY,
    polygonscan:"15NVZTFV87PZWW9GYC3SKVTD8WX624EYGS"
  },
  // subscribers: {
